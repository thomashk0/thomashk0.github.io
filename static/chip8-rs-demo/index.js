const baseDir = "static/chip8-rs-demo"

function loadRomList() {
    fetch(`${baseDir}/roms/index.json`)
...
async function init() {
    ...
    const {instance} = await WebAssembly.instantiateStreaming(fetch(`${baseDir}/chip8_wasm.wasm`));
